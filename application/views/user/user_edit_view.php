			...
			<div class="box">		
				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						...
						<div class="form-group" id="divLoket" style="display:<?php if($this->oldData->ID_KATEGORI_USER!='2') echo "none";?>">
							<label class="control-label col-sm-4" for="email">Pilih Loket :</label>
							<div class="col-sm-4">
								<select class="form-control" name="ID_BARANG" id="ID_BARANG">
									<option value="">Silahkan Pilih Loket</option>
									<?php 
									foreach($this->dataBarang as $data){
									?>
									<option <?php if($this->oldData->ID_BARANG == $data->ID_BARANG) echo "selected"; ?> value="<?php echo $data->ID_BARANG ?>"><?php echo $data->NAMA_BARANG ?></option>
									<?php
									}
									?>
								</select>
