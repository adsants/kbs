					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='nomor_rfid') echo "selected"; ?> value="nomor_rfid">Berdasarkan Nomor</option>
							</select>
						</div>
						<div class="col-sm-6">							
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_KARTU); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NOMOR_RFID,base_url().$this->uri->segment(1)."/delete/".$showData->ID_KARTU); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->NOMOR_RFID; ?></td>
				</tr>
				<?php
				$no++;
				}
