...
class Template_view extends CI_Controller {
    ...
    function __construct(){
	  ...
	  function load_front_view($content, $data = NULL){    
	   
        
        $data['header']     = $this->_ci->load->view('template/header_front_view', $data, TRUE);
        $data['content']    = $this->_ci->load->view($content, $data, TRUE);
        $data['footer']     = $this->_ci->load->view('template/footer_front_view', $data, TRUE);
